...
<div class="container">
  ...
  <div class="women-product">
    <div class="w_content">
      <div class="women">
        <h4>
          В каталоге: <span><?= $dataProvider->getTotalCount(); ?></span>
            <?= PluralHelper::format(
                $dataProvider->getTotalCount(), 'товар', 'товара', 'товаров'
            ); ?>
        </h4>
          ...
          <ul class="support support__sort w_nav">
            <li class="support dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?= Url::to(['catalog/search', 'sort' => 'id']) ?>">Стандартная</a></li>
                <li><a href="<?= Url::to(['catalog/search', 'sort' => 'price']) ?>">Дешевые</a></li>
                <li><a href="<?= Url::to(['catalog/search', 'sort' => '-price']) ?>">Дорогие</a></li>
              </ul>
            </li>
          </ul>
            <?php ActiveForm::end(); ?>
